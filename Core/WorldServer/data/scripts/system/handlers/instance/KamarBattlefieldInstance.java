    ...
    protected void startInstanceTask() {
        ...
        tasks.add(ThreadPoolManager.getInstance().schedule(new Runnable() {
            ...
            public void run() {
                ...
                kamarBattlefieldReward.sendPacket(2, null);
                ...
                sp(701902, 1259.38f, 1630.10f, 589.82f, (byte) 98, 0);
            }
        }, 45000)); //45 Sec.
    ...
    public void doReward() {
        for (Player player : instance.getPlayersInside()) {
            ...
            if (player.getRace().equals(kamarBattlefieldReward.getWinningRace())) {
                ...
                playerReward.setRewardAp((int) kamarBattlefieldReward.getWinnerPoints());
            } else {
                abyssPoint += kamarBattlefieldReward.getLooserPoints();
                playerReward.setRewardAp((int) kamarBattlefieldReward.getWinnerPoints());
            }
            playerReward.setReward1(188052670);
            playerReward.setReward2(186000236);
