...
public class RukibukiCircusTroupe extends GeneralInstanceHandler {
    ...
    public void onDie(Npc npc) {
        switch (npc.getNpcId()) {
            ...
            case 233161:
                ...
                if (cage != null) {
                    NpcActions.delete(cage);
                }
                spawn(831671, 479.62823f, 566.63184f, 202.125f, (byte) 116);
    ...
    public void cleanItems(Player player) {
        ...
        storage.decreaseByItemId(185000163, storage.getItemCountByItemId(185000163));
        storage.decreaseByItemId(185000184, storage.getItemCountByItemId(185000184));
        storage.decreaseByItemId(188100132, storage.getItemCountByItemId(188100132));
        storage.decreaseByItemId(188100133, storage.getItemCountByItemId(188100133));
        storage.decreaseByItemId(188100134, storage.getItemCountByItemId(188100134));
    }
