    ...
    public void onChangeStageList(StageList list) {
        ...
        switch (list) {
            ...
            case START_STAGE_2_PHASE_1:
                ...
                Npc monument = (Npc) spawn(831304, 340.3823f, 426.19424f, 294.75742f, (byte) 0);
                AI2Engine.getInstance().setupAI("defensetower", monument);
                ((NpcAI2) monument.getAi2()).setStateIfNot(AIState.IDLE);
