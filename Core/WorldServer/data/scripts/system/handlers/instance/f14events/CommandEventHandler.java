...
import com.aionemu.gameserver.eventEngine.eventmanager.events.xml.EventStartCondition;
...
public class CommandEventHandler extends BaseEventHandler {
    ...
    private synchronized void endBattle(PlayerGroup winner) {
        if (!this.eventIsComplete) {
            ...
            Balalaka.sayInWorldOrangeTextCenter("EventManager", String.format("Event: %s completed, won group with group leader: %s.",
