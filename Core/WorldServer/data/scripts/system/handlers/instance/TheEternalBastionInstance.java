...
public class TheEternalBastionInstance extends GeneralInstanceHandler {
    ...
    public void onDie(Npc npc) {
        ...
        switch (npcId) {
            // 1 Wave Begin
            case 231169: // Командир.
            case 231168: // Командир.
            case 231170: // Командир.
                Wave01Begin++;
                if (Wave01Begin == 1) {
                }
                if (Wave01Begin == 2) {
                ...
                if (Wave01Begin == 3) {
                    ...
                    spawn(231171, 656.05f, 212.84f, 223.95f, (byte) 74); // Командир Матук
                    // Левый Фланг
                    spawn(231172, 607.57f, 405.07f, 224.09f, (byte) 92); // Командир Бадут
                    spawn(233313, 609.18f, 407.78f, 224.12f, (byte) 92); // Охрана
                    spawn(233313, 605.69f, 407.75f, 224.01f, (byte) 92); // Охрана
                    // Правый Фланг
                    spawn(231173, 652.82f, 461.09f, 225.62f, (byte) 98); // Командир Касту
                    spawn(233313, 659.12f, 457.89f, 225.76f, (byte) 98); // Охрана
                    spawn(233313, 650.74f, 454.19f, 225.86f, (byte) 98); // Охрана
                    spawn(233315, 652.53f, 470.91f, 225.70f, (byte) 98); // Охрана
                    spawn(233315, 645.05f, 467.01f, 225.68f, (byte) 98); // Охрана
                }
                despawnNpc(npc);
                break;
            // 2 Wave Begin
            case 231171: // Командир.
            case 231172: // Командир.
            case 231173: // Командир.
                Wave02Begin++;
                if (Wave02Begin == 1) {
                }
                if (Wave02Begin == 2) {
                ...
                if (Wave02Begin == 3) {
                    sendMsg(1401817); 
                    // Топ
                    spawn(231176, 758.98f, 393.70f, 243.35f, (byte) 47); // Командир Нитра
                    // Левый Фланг
                    spawn(231175, 584.28f, 371.35f, 225.35f, (byte) 113); // Командир Каимду
                    spawn(233313, 588.92f, 364.62f, 224.98f, (byte) 113); // Охрана
                    spawn(233313, 592.30f, 373.44f, 224.06f, (byte) 113); // Охрана
                    spawn(233315, 577.68f, 377.08f, 225.97f, (byte) 113); // Охрана
                    spawn(233315, 575.73f, 368.95f, 226.28f, (byte) 113); // Охрана
                    // Правый Фланг
                    spawn(231174, 652.82f, 461.09f, 225.62f, (byte) 98); // Командир Мурат
                    spawn(233313, 659.12f, 457.89f, 225.76f, (byte) 98); // Охрана
                    spawn(233313, 650.74f, 454.19f, 225.86f, (byte) 98); // Охрана
                    spawn(233315, 652.53f, 470.91f, 225.70f, (byte) 98); // Охрана
                    spawn(233315, 645.05f, 467.01f, 225.68f, (byte) 98); // Охрана
                ...
                break;
            // 3 Wave Begin
            case 231175: // Командир.
            case 231174: // Командир.
            case 231176: // Командир.
                Wave03Begin++;
                if (Wave03Begin == 1) {
                }
                if (Wave03Begin == 2) {
                ...
                if (Wave03Begin == 3) {
                    ...
                    spawn(231143, 613.27f, 262.20f, 228.26f, (byte) 3); 
                    spawn(231152, 608.41f, 303.55f, 228.29f, (byte) 113);
                    spawn(231153, 626.25f, 351.28f, 226.01f, (byte) 113);
                    spawn(231154, 672.08f, 416.16f, 228.01f, (byte) 75); 
                    spawn(231155, 633.40f, 395.50f, 226.62f, (byte) 13);
                }
                despawnNpc(npc);
                break;
            // 4 Wave Begin
            ...
            case 231155: 
                ...
                if (Wave04Begin == 5) { 
                    sendMsg(1401819); 
                    spawn(231130, 744.22f, 293.07f, 233.69f, (byte) 42); 
                    spawn(231131, 712.75f, 289.28f, 249.28f, (byte) 1); 
                    spawn(231131, 747.78f, 323.02f, 249.28f, (byte) 88); 
                }
                despawnNpc(npc);
                break;
            case 284321: //Сигнал
            case 231148: //Сигнал
                ...
                rewardetPoints = 500;
                break;
            case 231130: // Босс Ранг S.
                stopInstance(player);
                if (checkRank(instanceReward.getPoints()) == 1) {
                    spawn(701913, 744.22f, 293.07f, 233.69f, (byte) 42); //Сундук Rank S.
                } else if (checkRank(instanceReward.getPoints()) == 2) {
                    spawn(701914, 744.22f, 293.07f, 233.69f, (byte) 42); //Сундук Rank A.
                } else if (checkRank(instanceReward.getPoints()) == 3) {
                    spawn(701915, 744.22f, 293.07f, 233.69f, (byte) 42); //Сундук Rank B.
                } else if (checkRank(instanceReward.getPoints()) == 4) {
                    spawn(701916, 744.22f, 293.07f, 233.69f, (byte) 42); //Сундук Rank C.
                } else if (checkRank(instanceReward.getPoints()) == 5) {
                    spawn(701917, 744.22f, 293.07f, 233.69f, (byte) 42); //Сундук Rank D.
                }
                final int bastion_exit = spawnRace == Race.ASMODIANS ? 730872 : 730871;
                spawn(bastion_exit, 767.10693f, 264.60303f, 233.49748f, (byte) 43); //Выход из данжа
                break;
            case 209516: 
            case 209517: 
                ...
                spawn(bastion_exit2, 767.10693f, 264.60303f, 233.49748f, (byte) 43); //Выход из данжа.
