...
public class Gameshop extends AdminCommand {
	...
	public void execute(Player admin, String... params) {
		...
		if ("delete".startsWith(params[0])) {
			...
			DAOManager.getDAO(InGameShopDAO.class).saveIngameShopItem(IDFactory.getInstance().nextId(), itemId, count, price, (byte) -1, (byte) -1, -1, 0, itemType, gift, titleDescription, description);
			PacketSendUtility.sendMessage(admin, "You remove from Ranking Sales [item:" + itemId + "]");
		}
