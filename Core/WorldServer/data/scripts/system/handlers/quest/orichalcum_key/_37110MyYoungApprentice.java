 ...
 *
 */
public class _37110MyYoungApprentice extends QuestHandler {

	private final static int questId = 37110;
				...
				if (player.isInGroup2()){
					...
					for (Player member : group.getMembers()) {
						if (member.isMentor() && MathUtil.getDistance(player, member) < GroupConfig.GROUP_MAX_DISTANCE) {
							...
							QuestService.addNewSpawn(npc.getWorldId(), npc.getInstanceId(), 217170, npc.getX(), npc.getY(), npc.getZ(), (byte) 0);
							return true;
						}
						else
