...
public class _20084NotDesertNorDanger extends QuestHandler {
    ...
    public void register() {
        ...
        qe.registerQuestNpc(231222).addOnAtDistanceEvent(questId);
    ...
    public boolean onDialogEvent(QuestEnv env) {
        ...
        if (qs != null && qs.getStatus() == QuestStatus.START) {
            ...
            } else if (targetId == 800554) { // Jeminu
                switch (dialog) {
                    case QUEST_SELECT: {
            ...
            } else if (targetId == 801153) { // Theodrik
                switch (dialog) {
                    case QUEST_SELECT: {
            ...
            } else if (targetId == 800555) { // Body of a Beritra Soldier
                switch (dialog) {
                    case QUEST_SELECT: {
