...
public class _23030UnusualObservations extends QuestHandler {
    ...
    public void register() {
        ...
        qe.registerQuestNpc(801117).addOnTalkEvent(questId);
        qe.registerQuestNpc(701688).addOnTalkEvent(questId);
        qe.registerQuestNpc(701689).addOnTalkEvent(questId);
        qe.registerQuestNpc(701690).addOnTalkEvent(questId);
    }
