 ...
 * @author Romanz
 */
public class _12852IoleRequest extends QuestHandler {

    private final static int questId = 12852;

    public _12852IoleRequest() {
        super(questId);
    }

    @Override
    public void register() {
        qe.registerQuestNpc(801238).addOnTalkEvent(questId);
