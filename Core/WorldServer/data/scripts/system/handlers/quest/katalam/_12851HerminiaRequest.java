 ...
 * @author Romanz
 */
public class _12851HerminiaRequest extends QuestHandler {

    private final static int questId = 12851;

    public _12851HerminiaRequest() {
        super(questId);
    }

    @Override
    public void register() {
        qe.registerQuestNpc(801237).addOnTalkEvent(questId);
