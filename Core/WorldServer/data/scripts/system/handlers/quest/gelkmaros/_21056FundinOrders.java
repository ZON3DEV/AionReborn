 ...
 *
 */
public class _21056FundinOrders extends QuestHandler {

	private final static int questId = 21056;

	public _21056FundinOrders() {
		super(questId);
	}

	@Override
	public void register() {
		qe.registerQuestItem(182207845, questId);
		...
		if (qs == null || qs.getStatus() == QuestStatus.NONE) {
			if (targetId == 0) {
				if (dialog == DialogAction.QUEST_ACCEPT_1) {
					removeQuestItem(env, 182207845, 1);
