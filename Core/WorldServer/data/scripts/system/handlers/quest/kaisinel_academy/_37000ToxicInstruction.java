 ...
 *
 */
public class _37000ToxicInstruction extends QuestHandler {

	private final static int questId = 37000;

	public _37000ToxicInstruction() {
		super(questId);
	}

	public void register() {
		qe.addHandlerSideQuestDrop(questId, 700967, 182210034, 5, 100);
		qe.registerQuestNpc(700967).addOnTalkEvent(questId);
		qe.registerQuestNpc(799835).addOnTalkEvent(questId);
	}
