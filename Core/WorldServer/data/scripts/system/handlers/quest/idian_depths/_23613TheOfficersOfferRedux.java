 ...
 * @author Evil_dnk
 */
public class _23613TheOfficersOfferRedux extends QuestHandler {

    private final static int questId = 23613;

    public _23613TheOfficersOfferRedux() {
        super(questId);
    }

    public void register() {
        qe.registerQuestItem(182213503, questId);
        ...
        if (qs == null || qs.getStatus() == QuestStatus.NONE) {
            ...
            if (targetId == 801545) {
                if (dialog == DialogAction.QUEST_SELECT) {
                    ...
                    removeQuestItem(env, 182213503, 1);
