    ...
    public boolean onDialogEvent(QuestEnv env) {
        ...
        if (qs.getStatus() == QuestStatus.START) {
            if (targetId == 205579) {
                ...
                switch (dialog) {
                    case USE_OBJECT: {
                        TeleportService2.teleportTo(player, 300490000, 495, 528, 417, (byte) 0, TeleportAnimation.BEAM_ANIMATION);
                ...
                switch (dialog) {
                    ...
                    case SETPRO7: {
                        ...
                        QuestService.spawnQuestNpc(300490000, player.getInstanceId(), 800352, 504.438f, 514.822f, 417.40436f, (byte) 0);
