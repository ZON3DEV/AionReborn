 ...
 * @author Romanz
 */
public class _13356HomerusRequest extends QuestHandler {

    private final static int questId = 13356;

    public _13356HomerusRequest() {
        super(questId);
    }

    @Override
    public void register() {
        qe.registerQuestNpc(801042).addOnTalkEvent(questId);
