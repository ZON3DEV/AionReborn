 ...
 * @author Romanz
 */
public class _23351TobaldRequest extends QuestHandler {

    private final static int questId = 23351;

    public _23351TobaldRequest() {
        super(questId);
    }
    ...
    public boolean onKillInWorldEvent(QuestEnv env) {
        ...
        if (env.getVisibleObject() instanceof Player && player != null && player.isInsideZone(ZoneName.get("SLEEPING_ELDERS_PLATEAU_600060000"))) {
