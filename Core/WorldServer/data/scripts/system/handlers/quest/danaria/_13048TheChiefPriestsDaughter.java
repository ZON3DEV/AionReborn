 ...
 * @author pralinka
 */
public class _13048TheChiefPriestsDaughter extends QuestHandler {

    private final static int questId = 13048;
    private final static int[] npcs = {801058, 801279, 206322};

    public _13048TheChiefPriestsDaughter() {
        super(questId);
    }
