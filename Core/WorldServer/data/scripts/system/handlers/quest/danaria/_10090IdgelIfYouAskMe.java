...
public class _10090IdgelIfYouAskMe extends QuestHandler {
    ...
    public void register() {
        ...
        qe.registerOnMovieEndQuest(851, questId);
        ...
        if (qs != null && qs.getStatus() == QuestStatus.START) {
            if (targetId == 800566) {
                ...
                switch (dialog) {
                    ...
                    case SET_SUCCEED: {
                        TeleportService2.teleportTo(player, 600060000, 1529.14f, 2922.8213f, 221.8727f, (byte) 30, TeleportAnimation.BEAM_ANIMATION);
    ...
    public boolean onEnterWorldEvent(QuestEnv env) {
      ...
      int var = qs.getQuestVarById(0);
            if (player.getWorldId() == 301000000) {
                if (var == 3) {
                    QuestService.addNewSpawn(301000000, player.getInstanceId(), 800817,  218.569061f, 510.007294f,  153.22841f, (byte) 68);
                    PacketSendUtility.sendPacket(player, new SM_PLAY_MOVIE(0, 851));
                    return true;
                }
            }
            else {
    ...
    public boolean onQuestTimerEndEvent(QuestEnv env) {
        ...
        if (qs.getStatus() == QuestStatus.START) {
            if (var == 7 && player.getWorldId() == 301000000) {
                ...
                updateQuestStatus(env);
                QuestService.addNewSpawn(301000000, player.getInstanceId(), 800818,  551.692383f, 430.005890f,  94.892334f, (byte) 45);
                return true;
            }
        }
        return false;
