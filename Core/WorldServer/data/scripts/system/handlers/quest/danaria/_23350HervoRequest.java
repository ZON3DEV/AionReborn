 ...
 * @author Romanz
 */
public class _23350HervoRequest extends QuestHandler {

    private final static int questId = 23350;

    public _23350HervoRequest() {
        super(questId);
    }

    @Override
    public void register() {
        qe.registerQuestNpc(801046).addOnTalkEvent(questId);
