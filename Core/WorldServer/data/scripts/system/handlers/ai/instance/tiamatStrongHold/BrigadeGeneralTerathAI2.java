...
public class BrigadeGeneralTerathAI2 extends AggressiveNpcAI2 {
    ...
    private synchronized void checkPercentage(int hpPercentage) {
        for (Integer percent : percents) {
            if (hpPercentage <= percent && !isGravityEvent) {
                ...
                AI2Actions.targetSelf(BrigadeGeneralTerathAI2.this);
                ...
                ThreadPoolManager.getInstance().schedule(new Runnable() {
                    ...
                    public void run() {
                        ...
                        spawn(283048, getOwner().getX(), getOwner().getY(), getOwner().getZ(), (byte) 0);
                    }
                }, 5000);
                ThreadPoolManager.getInstance().schedule(new Runnable() {
                    @Override
    ...
    private void strikeEvent() {
        AI2Actions.targetSelf(BrigadeGeneralTerathAI2.this);
        SkillEngine.getInstance().getSkill(getOwner(), 20743, 55, getOwner()).useNoAnimationSkill();
    }
