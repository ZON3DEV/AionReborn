    ...
    private void startTask() {
        task = ThreadPoolManager.getInstance().scheduleAtFixedRate(new Runnable() {
            ...
            public void run() {
                ...
                if (getPosition().getWorldMapInstance().getNpc(219570) == null) {
                    spawn(219570, 651.351990f, 326.425995f, 465.523987f, (byte) 8);
                    spawn(219570, 666.604980f, 314.497009f, 465.394012f, (byte) 27);
                    spawn(219570, 685.588989f, 342.955994f, 465.908997f, (byte) 68);
                    spawn(219570, 651.322021f, 346.554993f, 465.563995f, (byte) 111);
                }
            }
        }, 5000, 70000);
    }
