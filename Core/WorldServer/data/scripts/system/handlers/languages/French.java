...
public class French extends Language {
    ...
    public French() {
         ...
         * FFA System
         */
        addTranslatedMessage(CustomMessageId.FFA_IS_ALREADY_IN_TEAM, "S'il vous plaît quitter votre groupe et essayer encore.");
        ...
        addTranslatedMessage(CustomMessageId.FFA_ANNOUNCE_2, " joueurs l'ont deja fait.");
        addTranslatedMessage(CustomMessageId.FFA_ANNOUNCE_3, "Venez rejoindre la map FFA maintenant!");
        addTranslatedMessage(CustomMessageId.FFA_GHOST_KILL, "Un fantôme tue ");
        addTranslatedMessage(CustomMessageId.FFA_KILL_MESSAGE, " a tue ");
        addTranslatedMessage(CustomMessageId.FFA_KILL_NAME_1, " a fait de son mieux!");
        addTranslatedMessage(CustomMessageId.FFA_KILL_NAME_2, " est le meilleur!");
        addTranslatedMessage(CustomMessageId.FFA_KILL_NAME_3, " veut plus de sang!");
        addTranslatedMessage(CustomMessageId.FFA_KILL_NAME_4, " est comme un monstre fou!");
        addTranslatedMessage(CustomMessageId.FFA_KILL_NAME_5, " tu vas bien? ");
        addTranslatedMessage(CustomMessageId.FFA_KILL_NAME_6, " putain de skill?");
